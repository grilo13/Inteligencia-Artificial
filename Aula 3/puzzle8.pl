...
estado_inicial(((1,1),[[b,3,5],[1,2,8],[4,6,7]])). % solução de comprimento 8

%solução de comprimento 9, se do inicio até à solucao leva 9 passos, com movimentos validos
% com greedy vai dar stack overflow, uma vez que escolhe um caminho sem saída (infinito)
%estado_inicial(((2,1),[[3,b,5],[1,2,8],[4,6,7]]))
