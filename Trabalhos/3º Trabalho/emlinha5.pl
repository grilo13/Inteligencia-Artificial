...
linhas([[_,X,X,X,X],_,_,_],X) :- X \= v.

linhas([_,[X,X,X,X,_],_,_],X) :- X \= v.
linhas([_,[_,X,X,X,X],_,_],X) :- X \= v.

linhas([_,_,[X,X,X,X,_],_],X) :- X \= v.
linhas([_,_,[_,X,X,X,X],_],X) :- X \= v.

linhas([_,_,_,[X,X,X,X,_]],X) :- X \= v.
linhas([_,_,_,[_,X,X,X,X]],X) :- X \= v.

colunas([[X,_,_,_,_],[X,_,_,_,_],[X,_,_,_,_], [X,_,_,_,_]],X) :- X \= v.

colunas([[_,X,_,_,_],[_,X,_,_,_],[_,X,_,_,_], [_,X,_,_,_]],X) :- X \= v.

colunas([[_,_,X,_,_],[_,_,X,_,_],[_,_,X,_,_], [_,_,X,_,_]],X) :- X \= v.

colunas([[_,_,_,X,_],[_,_,_,X,_],[_,_,_,X,_], [_,_,_,X,_]],X) :- X \= v.

colunas([[_,_,_,_,X],[_,_,_,_,X],[_,_,_,_,X], [_,_,_,_,_]],X) :- X \= v.


diagonal([[X,_,_,_,_],[_,X,_,_,_],[_,_,X,_,_], [_,_,_,X,_]],X) :- X \= v.
diagonal([[_,_,_,X,_],[_,_,X,_,_],[_,X,_,_,_], [X,_,_,_,_]],X) :- X \= v.

diagonal([[_,X,_,_,_],[_,_,X,_,_],[_,_,_,X,_], [_,_,_,_,X]],X) :- X \= v.
diagonal([[_,_,_,_,X],[_,_,_,X,_],[_,_,X,_,_], [_,X,_,_,_]],X) :- X \= v.
